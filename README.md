...
A browser-based Irish pub bartending simulation. You're behind the bar at The Corrib — pour proper pints of Guinness, keep the regulars happy, and try not to get fired. One HTML file, no dependencies.
